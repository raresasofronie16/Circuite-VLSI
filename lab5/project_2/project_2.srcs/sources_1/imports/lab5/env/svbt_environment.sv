class svbt_environment extends svbt_base_unit;
   ...
   mailbox packet_mbox, data_in_mbox, channel_out_mbox[$];
   ...
   function new (int unsigned number_of_packets,
      ...
      begin
        case(i)
            0: begin
                channel_out_monitor = new(i, top.output_intf0.rcv,
                channel_out_mbox[i], top.reset_intf.rcv, "CHANNEL OUT MONITOR 0", 10);
            
            end
        
            1: begin
                channel_out_monitor = new(i, top.output_intf1.rcv,
                channel_out_mbox[i], top.reset_intf.rcv, "CHANNEL OUT MONITOR 1", 11);
            
            end
            
            
            2: begin
                channel_out_monitor = new(i, top.output_intf2.rcv,
                channel_out_mbox[i], top.reset_intf.rcv, "CHANNEL OUT MONITOR 2", 12);
