...
class svbt_packet;
   ...
   //add a rand bit 'flag_mismatched_parity' to control the good/bad parity generation
   ...
   constraint keep_flag_mismatched_parity_1;											
   rand int delay;
   ...
   function void post_randomize();
      //take 'flag_mismatched_parity' when computing the parity
